...
I am a **Senior Staff SoC Design Engineer** with over a decade of experience in the semiconductor industry. My career has been defined by a "Physical-Aware" approach to Front-End design—ensuring that high-level architectural intent translates seamlessly into high-yield GDSII.
...
### 🛠️ Technical Toolkit
* **Core:** SoC Integration, RTL Design, IP Leadership, Mixed-Signal Wrappers.
* **Sign-off:** LEC/FEC, CDC/RDC, RTL Linting, STA, Synthesis, ECO.
* **Low Power:** Low-power (UPF) Design, conformal low power check (CLP).
...
**Let's Connect:** [LinkedIn](linkedin.com/in/anusha-sree-ganesan-57077085/) | 📍 Austin, TX
